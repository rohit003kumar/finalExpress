  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 text-center sm:text-left">
        <div className="p-2 bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl mx-auto sm:mx-0">
          <Grid3X3 className="w-8 h-8 text-purple-600" />
        </div>
        <div className="mt-2 sm:mt-0">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
            Enhanced Slot Template Manager
          </h1>
          <p className="text-gray-600 mt-1 text-sm sm:text-base">
            Create, edit, and auto-generate time slot templates
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto">
        <button
          onClick={handleCleanupPastDates}
          className="flex items-center justify-center space-x-2 px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors w-full sm:w-auto"
        >
          <Archive className="w-4 h-4" />
          <span>Cleanup Past</span>
        </button>
